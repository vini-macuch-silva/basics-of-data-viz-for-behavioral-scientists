...
Unsurprisingly, the output of the code above tells us that `2` is not greater than `3`. Other important logical operations include checking whether two elements are equal to one another `2 == 3`, not equal to another `2 != 3`, or checking whether the relation between two sets of elements or two individual operations is true or false. For instance, check the difference between the output of the two code snippets below.
