...
Next, we're modifying the y-axis and increasing the legibility of the ticks/ labels.
...
Notice that when using multiple layers transparency might not work as intended.
